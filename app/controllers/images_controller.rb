class ImagesController < ApplicationController
  ...
  def upload_image
    if params[:file]
      ...
      path = Rails.root.join "public/uploads/floala/", file_name
  ...
  def access_file
    if File.exists? Rails.root.join("public", "uploads", "floala", params[:name])
      send_data File.read(Rails.root.join "public", "uploads", "floala", params[:name]),
