...
$(document).ready(function(){
  ...
  $( ".click-tag-event" ).click(function() {
    if ($('#tags').tagExist($(this).find('span.tag-name').text())) {
      swal({
        title: I18n.t('warning'),
        text: I18n.t('existed_tag'),
        type: 'warning',
      ...
      $('#tags').addTag($(this).find('span.tag-name').text());
    }
...
//   $('#suggest_users').tagsInput({
//     autocomplete_url: function (request, response) {
//       var key = request.term.substr(request.term.length -1);
//       if (suggest_users) {
//         username = username + request.term.substr(request.term.length -1);
//         $.ajax({
//           url: '/suggest_tags',
//           data: { key: username },
//           success: function (data) {
